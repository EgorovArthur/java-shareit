...
public class IntItemRequestServiceImplTest {
    ...
    private final ItemRequest request = ItemRequest.builder().description("Куплю самокат").requestor(requestor)
    ...
    void testGetUserRequests() {
        ...
        assertEquals("Куплю самокат", actualRequest.getDescription());
